export const projectsList = [
  ...
  },
  {
    ...
    github: "https://github.com/alx-zhu/todo-list",
    text: "To-do list created using HTML, CSS, and Javascript as a part of the Studyfind curriculum. This project marked my first time combining JavaScript with HTML and CSS and opened a window into more interactive websites. This to-do list was inspired by Kevin Powell's collaboration with Web Dev Simplified: https://github.com/kevin-powell/todo-list-collab. The to-do list allows users to create multiple lists as well as add tasks and deadlines. The to-do list requirements were as follows: application must be able to 1) Add tasks to list, 2) Add deadline for each task, 3) Check off tasks, 4) Sort tasks by name, 5) Sort tasks by deadline, 6) Toggle visibility of completed tasks, 7) Filter tasks by day.",
    clickable: true,
  },
  {
    id: 4,
    ...
    text: "This HTML/CSS Personal Website was created as a part of the Studyfind Curriculum, and was my very first experience coding a full website. The project required the creation of a Home, About, and Contact page that incorporate elements we had learned including Flexbox and Grid elements, links, inputs, buttons, and images. The initial design was inspired by Traversy Media's Responsive Website video: https://www.youtube.com/watch?v=p0bGHP-PXD4.",
    clickable: true,
  },
  {
    id: 3,
